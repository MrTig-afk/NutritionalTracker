...
export default function MacroBar({ label, current, goal, color, digits = 1, suffix = "" }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12 }}>
        ...
        <span style={{ color: over ? "var(--danger)" : "var(--text)", fontWeight: 600 }}>{current.toFixed(digits)} / {goal}{suffix}{over && " ⚠"}</span>
      </div>
